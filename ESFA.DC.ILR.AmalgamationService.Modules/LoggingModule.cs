...
using ESFA.DC.ILR.AmalgamationService.Modules.Service;
namespace ESFA.DC.ILR.AmalgamationService.Modules
{
    public class LoggingModule : Module
    {
        protected override void Load(ContainerBuilder containerBuilder)
        {
            ...
            containerBuilder.Register(c => (ServiceLogger)LogManager.GetLogger("AmalgamationService", typeof(ServiceLogger))).As<ILogger>();
        }
